...
<body>
            ...
            <div class="page-heading">
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <button type="button" class="btn btn-secondary btn-lg" data-bs-toggle="modal" data-bs-target="#modalTambahData">
                            Tambah data
                        </button>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($product->foto)
                                            <img src="{{ Storage::url('public/products/' . $product->foto) }}" width="100" alt="Foto Produk">
                                        @else
                                            <span>No image</span>
                                        @endif
                                    </td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalTambahDataLabel">Tambah Data Produk</h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="kategori" class="form-control">
                                                    <option value="">--Pilih Kategori--</option>
                                                        ...
                                                        <option value="Aki Kapal">Aki Kapal</option>
                                            ...
                                            <div class="mb-3">
                                                <label for="fotoProduct" class="form-label">Foto Product</label>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="formEditProduct" method="POST" enctype="multipart/form-data">
                                        ...
                                        @method('PUT')
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="modalEditDataLabel">Edit Data Produk</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="editFotoProduct" class="form-label">Foto Produk (opsional)</label>
                                                <input type="file" class="form-control" id="editFotoProduct" name="fotoProduct">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
    ...
    <script>
        function openEditModal(product) {
            ...
            console.log('Deskripsi:', product.deskripsi);

            const form = document.getElementById('formEditProduct');
            form.action = `/products/${product.id}`;

            document.getElementById('editProductId').value = product.id;
            document.getElementById('editNamaProduk').value = product.product;
            ...
            const editModal = new bootstrap.Modal(document.getElementById('modalEditData'));
            editModal.show();
        }
    </script>
